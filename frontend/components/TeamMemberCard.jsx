        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="mt-3 grid grid-cols-2 gap-2">
            <div className="rounded-2xl bg-white/35 ring-1 ring-white/60 p-2.5 inset-highlight">
              ...
              <p className="text-sm font-semibold text-slate-900">{fmtCurrency(member.hourly_rate)}/h</p>
            </div>
            <div className="rounded-2xl bg-white/35 ring-1 ring-white/60 p-2.5 inset-highlight">
              <p className="text-[10px] text-slate-500">進行中</p>
              <p className="text-sm font-semibold text-slate-900">{member.active_allocations || 0} 任務</p>
            </div>
          </div>
