...
export default function Gantt({
  ...
  return (
    <div className="surface rounded-[22px] overflow-hidden select-none relative" style={{ fontFamily: 'inherit' }}>
      ...
      {tooltip && !dragging && (
        <div style={{ position: 'fixed', left: tooltip.x + 12, top: tooltip.y - 60, zIndex: 100, pointerEvents: 'none' }}>
          <div className="bg-gray-900/90 text-white rounded-lg px-3 py-2 text-xs shadow-xl backdrop-blur">
