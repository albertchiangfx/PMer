...
-- Allocations (project ↔ member, used by current Dashboard / Schedule UI).
-- Mirrors the time_allocations above, but at project level so today's
-- ranges produce visible "本日任務" rows.
INSERT INTO allocations (id, project_id, member_id, start_date, end_date, notes)
VALUES
  -- Dragon Chronicle S2
  ('77777777-0001-0001-0001-000000000001', '33333333-0001-0001-0001-000000000001', '22222222-0001-0001-0001-000000000002', CURRENT_DATE - INTERVAL '30 days', CURRENT_DATE + INTERVAL '14 days', 'Main dragon body, wings, scales'),
  ('77777777-0001-0001-0001-000000000002', '33333333-0001-0001-0001-000000000001', '22222222-0001-0001-0001-000000000007', CURRENT_DATE + INTERVAL '10 days', CURRENT_DATE + INTERVAL '35 days', 'Full body rig with wing controls'),
  ('77777777-0001-0001-0001-000000000003', '33333333-0001-0001-0001-000000000001', '22222222-0001-0001-0001-000000000003', CURRENT_DATE - INTERVAL '20 days', CURRENT_DATE + INTERVAL '20 days', 'Castle exterior and interior'),
  ('77777777-0001-0001-0001-000000000004', '33333333-0001-0001-0001-000000000001', '22222222-0001-0001-0001-000000000003', CURRENT_DATE + INTERVAL '30 days', CURRENT_DATE + INTERVAL '65 days', 'Primary animation pass'),
  ('77777777-0001-0001-0001-000000000005', '33333333-0001-0001-0001-000000000001', '22222222-0001-0001-0001-000000000006', CURRENT_DATE + INTERVAL '45 days', CURRENT_DATE + INTERVAL '75 days', 'Fire breath, impact effects'),
  ('77777777-0001-0001-0001-000000000006', '33333333-0001-0001-0001-000000000001', '22222222-0001-0001-0001-000000000008', CURRENT_DATE + INTERVAL '70 days', CURRENT_DATE + INTERVAL '110 days', 'Episode comp and grade'),
  ('77777777-0001-0001-0001-000000000007', '33333333-0001-0001-0001-000000000001', '22222222-0001-0001-0001-000000000001', CURRENT_DATE - INTERVAL '60 days', CURRENT_DATE + INTERVAL '120 days', 'Art direction, supervision'),
  ('77777777-0001-0001-0001-000000000008', '33333333-0001-0001-0001-000000000001', '22222222-0001-0001-0001-000000000010', CURRENT_DATE - INTERVAL '60 days', CURRENT_DATE + INTERVAL '120 days', 'Production management'),
  -- NeonCity VFX Pack
  ('77777777-0002-0001-0001-000000000001', '33333333-0001-0001-0001-000000000002', '22222222-0001-0001-0001-000000000006', CURRENT_DATE - INTERVAL '15 days', CURRENT_DATE + INTERVAL '10 days', 'Neon spark and glow systems'),
  ('77777777-0002-0001-0001-000000000002', '33333333-0001-0001-0001-000000000002', '22222222-0001-0001-0001-000000000005', CURRENT_DATE + INTERVAL '10 days', CURRENT_DATE + INTERVAL '40 days', 'Custom HLSL shaders'),
  ('77777777-0002-0001-0001-000000000003', '33333333-0001-0001-0001-000000000002', '22222222-0001-0001-0001-000000000004', CURRENT_DATE - INTERVAL '20 days', CURRENT_DATE + INTERVAL '25 days', 'Building facades, props, signs'),
  -- TurboRacer Cinematic (kicks off in two weeks)
  ('77777777-0003-0001-0001-000000000001', '33333333-0001-0001-0001-000000000003', '22222222-0001-0001-0001-000000000002', CURRENT_DATE + INTERVAL '14 days', CURRENT_DATE + INTERVAL '35 days', 'Hero car modeling & texturing'),
  ('77777777-0003-0001-0001-000000000002', '33333333-0001-0001-0001-000000000003', '22222222-0001-0001-0001-000000000003', CURRENT_DATE + INTERVAL '40 days', CURRENT_DATE + INTERVAL '80 days', 'Cinematic animation pass'),
  ('77777777-0003-0001-0001-000000000003', '33333333-0001-0001-0001-000000000003', '22222222-0001-0001-0001-000000000009', CURRENT_DATE + INTERVAL '14 days', CURRENT_DATE + INTERVAL '90 days', 'Director - cinematic supervision'),
  -- Two "today" tasks for the default viewer (陳志遠 / Art Director) so
  -- Dashboard 本日任務 has visible content on first load.
  ('77777777-0001-0001-0001-000000000009', '33333333-0001-0001-0001-000000000001', '22222222-0001-0001-0001-000000000001', CURRENT_DATE - INTERVAL '3 days', CURRENT_DATE + INTERVAL '4 days', 'Episode 3 分鏡審核（含角色情緒 keyframe）'),
  ('77777777-0002-0001-0001-000000000004', '33333333-0001-0001-0001-000000000002', '22222222-0001-0001-0001-000000000001', CURRENT_DATE - INTERVAL '1 days', CURRENT_DATE + INTERVAL '2 days', '美術風格指南最終確認 — 霓虹色板 v3')
ON CONFLICT DO NOTHING;
